import { INSTITUTE_DEMO_SOURCE } from "./institute-demo.ts";
...
export const LAYERS: { id: LayerId; title: string; source: string; url?: string; description: string; color: string }[] = [
  { id: "inventory", title: "Sources de pollution potentielle", source: "Inventaire écocitoyen", url: "/carte", description: "Les sites de l’inventaire participatif, avec leurs secteurs d’activité.", color: "#1d6ab2" },
  ...
  { id: "wood", title: "Chauffage résidentiel", source: INSTITUTE_DEMO_SOURCE, description: "Préfiguration d’un suivi de l’Institut écocitoyen. Carte de chaleur entièrement simulée, pas des mesures de l’Institut. Les zones et intensités sont inventées : ni mesures, ni émissions estimées, ni seuils sanitaires.", color: "#f52222" },
  { id: "atmo", title: "Stations de mesure · Atmo", source: "Atmo Auvergne-Rhône-Alpes", url: "https://www.atmo-auvergnerhonealpes.fr/dataviz/mesures-aux-stations", description: "Stations aux coordonnées publiées par Atmo : tous les polluants mesurés, dates et historique.", color: "#8b5cf6" },
  { id: "rivers", title: "Cours d’eau", source: "Agence de l’eau · Hub’Eau · Naïades", url: "https://hubeau.eaufrance.fr/page/api-qualite-cours-deau", description: "État ou potentiel écologique officiel à la station, et analyses physico-chimiques disponibles.", color: "#0891b2" },
