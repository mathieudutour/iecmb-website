...
const HOTSPOTS = [
  ...
  [45.886, 6.803, 0.90, 0.018, 0.009],
  [45.909, 6.836, 0.81, 0.018, 0.010],
  [45.925, 6.868, 1.03, 0.018, 0.010],
  [45.944, 6.892, 0.87, 0.015, 0.010],
  [45.979, 6.925, 0.82, 0.017, 0.010],
] as const;
