...
import { coordinatePrecision, groundwaterCatalogueUrl, groundwaterAnalysisUrl, parseGroundwaterStations, parseGroundwaterAnalyses, groundwaterResultLabel, groundwaterResultUnit, loadGroundwaterAnalyses } from '../src/lib/groundwater.ts';
import { loadGroundwaterCatalogue } from '../src/lib/groundwater-source.ts';
