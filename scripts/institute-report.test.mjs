...
import { bioInstituteReport, soilInstituteReport, waterInstituteReport } from '../src/lib/institute-report.ts';
import { BIO_DEMO_SITES } from '../src/lib/bio-monitoring-demo.ts';
import { SOIL_DEMO_SITES } from '../src/lib/soil-demo.ts';
import { INSTITUTE_WATER_SITES } from '../src/lib/institute-water-demo.ts';
