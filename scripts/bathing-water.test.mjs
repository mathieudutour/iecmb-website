...
import { BATHING_SITES, bathingQuality, bathingSamples } from "../src/lib/bathing-water.ts";
import { parseBathingPage, loadBathingWater } from "../src/lib/bathing-water-source.ts";
